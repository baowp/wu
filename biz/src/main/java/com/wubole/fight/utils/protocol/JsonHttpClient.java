...
public class JsonHttpClient {
	...
	public JSON post(String url, Object sendDTO) {
	...
	public JSON post(String url, HttpEntity httpEntity) {
		HttpClient httpclient = newHttpClientInstance();
